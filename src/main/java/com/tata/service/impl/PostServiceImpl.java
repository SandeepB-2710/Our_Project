...
public class PostServiceImpl implements PostService {
	...
	public List<PostDto> getPostByCategory(Integer categoryId) {
		...
		List<Post> posts = this.postRepository.findPostByCategoryOrderByCreatedAtDesc(category);
	...
	public List<PostDto> getPostByUser(Integer userId) {
		...
		List<Post> posts = this.postRepository.findPostByUserOrderByCreatedAtDesc(user);
